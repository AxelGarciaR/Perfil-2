...
CREATE TABLE `calificaciones` (
  ...
  KEY `fk_calificaciones_inscripciones` (`id_inscripcion`),
  CONSTRAINT `calificaciones_ibfk_1` FOREIGN KEY (`id_inscripcion`) REFERENCES `inscripciones` (`id_inscripcion`),
  CONSTRAINT `fk_calificaciones_inscripciones` FOREIGN KEY (`id_inscripcion`) REFERENCES `inscripciones` (`id_inscripcion`)
